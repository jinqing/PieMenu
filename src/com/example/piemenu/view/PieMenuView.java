package com.example.piemenu.view;
...
public class PieMenuView extends RelativeLayout {
	 ...
	 *            動畫耗時
	 */
	public void init(int[] imgResId,String[]names, int showhideButtonId, int crossId,
